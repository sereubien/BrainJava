...
class aaaaa {
    ...
    public static void main(String args[]) {
    	...
    	Person1[] persons = new Person1[3]; //  배열객체 
  
    	for(int i=0; i<persons.length; i++) {
    		persons[i] = new Person1();  // 생성자 호출하여 배열레퍼런스 대입
    	}
    	...
    	Person1 person;          // 레퍼런스 변수 선언
    	person = new Person1();	// 객체 생성  - new 연산자(생성자) 이용
